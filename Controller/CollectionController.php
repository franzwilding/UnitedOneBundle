...
abstract class CollectionController extends CRUDBaseController implements ControllerViewInterface {
  ...
  protected function getTemplateForAction($action) {
    switch($action) {
      case 'index': return 'UnitedOneBundle:Collection:index.html.twig'; break;
      case 'view': return 'UnitedOneBundle:Collection:view.html.twig'; break;
      case 'ajax': return 'UnitedOneBundle:Collection:ajax.html.twig'; break;
      case 'item': return 'UnitedOneBundle:Collection:item.html.twig'; break;
